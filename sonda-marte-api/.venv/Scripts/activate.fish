...
set -gx VIRTUAL_ENV 'C:\Users\Usuário\Documents\sonda-marte-api\sonda-marte-api\sonda-marte-api\.venv'
...
if test -n sonda-marte-api-py3.14
    set -gx VIRTUAL_ENV_PROMPT sonda-marte-api-py3.14
else
